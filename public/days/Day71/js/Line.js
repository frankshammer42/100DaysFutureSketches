class Line {
    ...
    update(){
        this.line.rotation.x += this.rotSpeed*2;
        // if (this.rotCounter > this.rotMax){
        //     this.rotSpeed *= -1;
        //     this.rotCounter = 0;
        // }
        // this.line.rotation.z += this.rotSpeed;
        this.line.position.z += this.rotSpeed*50;
        this.sinStart += this.sinStartVel;
        this.yMax += this.peakVal;
        if (this.yMax >= 120 || this.yMax < -120){
            this.peakVal *= -1;
        }
