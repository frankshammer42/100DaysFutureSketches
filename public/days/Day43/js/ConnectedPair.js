class ConnectedPair {
    constructor(halfSize, position, rotation){
        ...
        // this.unitSpeed = (0.1 - this.rotSpeed) / 1000;
        this.rotSpeed = 0.1;
        this.sizeChange = Math.random()*2;
    }
    ...
    update(){
        this.pair.rotation.z += this.rotSpeed;
        this.pair.rotation.x += this.rotSpeed;
        this.leftX -= this.sizeChange;
        this.rightX += this.sizeChange;
