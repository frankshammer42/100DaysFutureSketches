...
function init() {
    ...
    //create creature
    amebaBug = new AmebaBug(50, new THREE.Vector3(0,0,0), 500);
    scene.add(amebaBug.bugCircle.sourceCircle);
    for (let i=0; i<amebaBug.bugFeet.length; i++){
        scene.add(amebaBug.bugFeet[i].line);
    }
    amebaBug0 = new AmebaBug(50, new THREE.Vector3(-500,0,0), 100);
    scene.add(amebaBug0.bugCircle.sourceCircle);
    for (let i=0; i<amebaBug0.bugFeet.length; i++){
        scene.add(amebaBug0.bugFeet[i].line);
    }
    //------------------------------------------Post Processing
...
//         currentPos.x += i*step;
//         currentRadius *= Math.pow(downScaler, i);
//         currentScale *= Math.pow(downScaler, i);
//         let newBug = new AmebaBug(currentRadius, currentPos, currentScale);
//         scene.add(newBug.bugCircle.sourceCircle);
//         for (let i=0; i<newBug.bugFeet.length; i++){
//             scene.add(newBug.bugFeet[i].line);
//         }
//         amebaBugs.push(newBug);
//     }
// }
...
function animate() {
    ...
    rgbShift.uniforms.time.value = wave.uniforms.time.value = t;
