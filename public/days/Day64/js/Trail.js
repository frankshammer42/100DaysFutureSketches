...
let stats;
// rotatio
let groupRotx = Math.random()*0.01;
let groupRoty  = Math.random()*0.01;
let groupRotz  = Math.random()*0.01;
...
function animate() {
    ...
    pointsGroup.rotation.x += groupRotx;
    pointsGroup.rotation.y += groupRoty;
    pointsGroup.rotation.z += groupRotz;
    TWEEN.update();
