...
function init() {
    ...
    // let start = new THREE.Vector3(0, 1000, 0);
    // let end = new THREE.Vector3(0, -1000, 0);
    // knot= new Line(start, end, 1, 2000, 500, 9);
...
function createKnots(){
    ...
    for (let i=0; i<100; i++){
        ...
        let knotsNumber = Math.floor(Math.random() * 10) + 1;
        console.log(knotsNumber);
        let newKnot = new Line(start, end, 1, 2000, indexToChange, knotsNumber);
