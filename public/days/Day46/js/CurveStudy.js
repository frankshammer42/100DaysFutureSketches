...
function init() {
    ...
    camera.position.x = 162357;
    camera.position.y = 5723;
    camera.position.z = -3692;
    camera.far = 1000000;
...
function moveAway(){
    console.log("start moving away");
    let destination = new THREE.Vector3(585303, 20631, -13309);
    moveCamera(destination, 50000);
}
