class Cube {
    constructor(start_x, start_y, start_z, halfLengthFront, halfLengthSide, halfLengthDepth, rotationAxis, positiveRotation){
        ...
        this.upThreshold = this.startY + 500;
    ...
    update(){
        ...
        // this.createContainer();
        // this.container.rotation.x += this.rotationStep;
        // this.container.rotation.y += this.rotationStep;
        // this.container.rotation.z += this.rotationStep;
        // this.container.rotation.z += this.rotationStep;
        // if (this.container.rotation.z > 0.2 || this.container.rotation.z < -0.2){
        //     this.rotationStep *= -1;
        // }
        // console.log(this.y);
        // this.y += 2;
